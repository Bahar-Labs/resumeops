...
2. **Mirror the JD's language.** If the JD says "crosswalks," don't say "mappings" unless you also say "crosswalks." If they say "continuous monitoring," use that phrase. ATS systems and hiring managers both pattern-match on vocabulary.
...
5. **Quantify wherever possible.** Years of experience, number of frameworks, scale of organizations, number of assessment cycles, size of teams or vendor ecosystems. Specifics beat adjectives.
...
10. **Position as senior individual contributor, not manager.** The candidate targets IC roles: SME, Staff, Principal, Lead (technical/functional), Senior Advisor, Architect. Emphasize depth of craft, framework expertise, and hands-on execution. Do not emphasize team leadership, people management, direct reports, or "building and leading teams." When describing collaborative work, use "partner with," "coordinate across," or "advise" rather than "manage," "supervise," or "lead a team of." Fractional CCO/DPO work should be framed as owning a compliance function, not managing staff.
...
1. **Address a real person.** Use this hierarchy, in order of preference:
   ...
   - Budget owner by title (the person one level above the role who owns the headcount -- for GRC roles: CISO, VP of Security, Head of Trust, CCO; for product-GRC hybrids: VP of Product or Head of Security)
   - Internal recruiter by name (searchable on LinkedIn as "[Company] recruiter" filtered by security/compliance)
   - Specific title without a name ("Dear Head of Security" or "Dear VP of Trust")
...
- **Paragraph 2 (The Proof):** Highlight 2 of the candidate's most concrete, demonstrable accomplishments that prove they have solved this exact type of problem before. For GRC/compliance roles, "quantifiable" means: scale of organizations assessed, number of concurrent frameworks managed, regulatory enforcement outcomes, program-to-certification results, or operational impact. Not everything reduces to revenue numbers.
...
### GRC Platforms / Tools (hands-on experience)
[List platforms and tools you use regularly]
